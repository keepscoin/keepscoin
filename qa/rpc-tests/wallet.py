...
#   c) node1 mines 32 blocks, so now node 0 has 500000KPC, node 1 has 4250KPC, node2 has none.
#   d) node0 sends 601 KPC to node2, in two transactions (301 KPC, then 300 KPC).
