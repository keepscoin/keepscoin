...
allowing somebody to distribute a Bitcoin-Qt.app or kpcoin-qt-setup.exe with a valid
...
that the kpcoin-qt.exe file inside the installer had not been tampered with.
