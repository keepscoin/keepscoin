...
###   This script attempts to download the signature file SHA256SUMS.asc from kpcoin.org
...
WORKINGDIR="/tmp/kpcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://kpcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://kpcoin.org/bin/"
VERSIONPREFIX="kpcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'kpcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[kpcoin-]<version>-[rc[0-9]] (example: kpcoin-0.9.2-rc1)"
   echo "wget output:"
