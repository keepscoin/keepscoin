Contributing to KEEPsCoin Core
==================================

The KEEPsCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KEEPsCoin Core project, and is not to be
confused with overall KEEPsCoin Network Protocol consensus changes.

Whether a pull request is merged into KEEPsCoin Core rests with the project merge
...
Patches that change KEEPsCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the KEEPsCoin consensus, it must have been
...
The project leader is the release manager for each KEEPsCoin Core release.
