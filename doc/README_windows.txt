...
Intro
-----
KEEPsCoin (KPC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. KEEPsCoin utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run keepscoin-qt.exe.

KEEPsCoin Core is the original KEEPsCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of KEEPsCoin transactions;
