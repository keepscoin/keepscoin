The following is a list of assets used in the kpcoin source and their proper attribution.
...
* License: MIT
* Site: [https://kpcointalk.org/index.php?topic=15276.0](https://kpcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original kpcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/kpcoin.icns, src/qt/res/src/kpcoin.svg,
	src/qt/res/src/kpcoin.ico, src/qt/res/src/kpcoin.png,
	src/qt/res/src/kpcoin_testnet.png, docs/kpcoin_logo_doxygen.png,
