...
// Copyright (c) 2017 The KEEPsCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef KPCOIN_CHAINPARAMS_H
#define KPCOIN_CHAINPARAMS_H
 ...
 * KEEPsCoin system. There are three: the main network on which people trade goods
