...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/kpcoin"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("KEEPsCoin Core"),
     ...
     * override -datadir in the keepscoin.conf file in the default data directory
     * (to be consistent with keepscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
