                                                  ...
                                                  model(0)
{
    ...
    // normal kpc address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying kpc address(es)
    ui->payTo_is->setFont(GUIUtil::kpcoinAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("KPC")
    updateDisplayUnit();
}
