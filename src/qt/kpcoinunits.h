...
#ifndef KPCOIN_QT_KPCOINUNITS_H
#define KPCOIN_QT_KPCOINUNITS_H
...
/** KPC unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** KPC units.
      @note Source: https://en.kpcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        KPC,
        mKPC,
