...
{
    BOOST_CHECK(TestSplitHost("www.kpcoin.org", "www.kpcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.kpcoin.org]", "www.kpcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.kpcoin.org:80", "www.kpcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kpcoin.org]:80", "www.kpcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9111", "127.0.0.1", 9111));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9111", "127.0.0.1", 9111));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9111", "::ffff:127.0.0.1", 9111));
    BOOST_CHECK(TestSplitHost("[::]:9111", "::", 9111));
    BOOST_CHECK(TestSplitHost("::9111", "::9111", -1));
    BOOST_CHECK(TestSplitHost(":9111", "", 9111));
    BOOST_CHECK(TestSplitHost("[]:9111", "", 9111));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9111", "127.0.0.1:9111"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9111", "[::]:9111"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
