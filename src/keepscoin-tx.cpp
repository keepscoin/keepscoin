...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KEEPsCoin Core keepscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  keepscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded keepscoin transaction") + "\n" +
                               "  keepscoin-tx [options] -create [commands]   " + _("Create hex-encoded keepscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded keepscoin transaction
