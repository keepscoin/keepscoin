...
#ifndef KPCOIN_WALLET_H
#define KPCOIN_WALLET_H
...
public:
    ...
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64_t nSearchInterval, CAmount nFees, CMutableTransaction& txNew, unsigned int& nTxNewTime);
    bool MultiSend();
