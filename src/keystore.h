...
#ifndef KPCOIN_KEYSTORE_H
#define KPCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/kpcoin/bips/blob/master/bip-0013.mediawiki
